...
// const BusController = require("../controllers/conductor");
...
router.get('/myapi', async (req, res, next) => {
    try{
        // res.status(800);
        // res.json({status: true, message: "Got It" });
        ...
        console.log(passenger, card, ssid, vehicle, board, currtime);
                        ...
                        // setTimeout(() => {
                            // var farecalc = fare(distancecalc);
                            // console.log(out);
                            // console.log("Distance : ", journeydistance , "m");
                            // console.log("Distance : ", journeydistance/1000 , "Km");

                            // res.status(800);
                            // res.json({status : true});

                            // console.log("Fare : ", farecalc);

                        //     console.log("It's me : ", journeydistance);}, 1000);
                        // setTimeout(() => {
                        //     var farecalc = fare(journeydistance);
                        //     console.log("Fare : ", farecalc);
                        // }, 1000);
                        // test
                        
    setTimeout(() => {                        
        //fetch location by SSID    OK
        ...
        // boarding case
        // res.status(800);
        // res.json({status: true, message: "Seat Available"});
    ...
    //     origin: '22.266245, 88.354607',
    //     destination: '22.238052, 88.272562',
    //     mode: "driving",
...
// https://maps.googleapis.com/maps/api/directions/json?origin=22.266245, 88.354607&destination=22.238052, 88.272562 &mode=driving&key=AIzaSyA5fav9dMmYViqtOp7p_4JEZpVsfBVnzMM
// "https://maps.googleapis.com/maps/api/directions/json?origin="+source_loc+"&destination="+destination_loc +"&mode=driving&key="+apikey
